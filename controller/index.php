...
<body class="bg-gradient-login" style="background-image: url('../view/img/logo/loral1.jpe00g');">
  <!-- Login Content -->
          ...
          <div class="card-body p-0">
            <div class="row">
              <div class="col-lg-12">
                ...
                <h5 align="center">STUDENT ATTENDANCE & WORK TRACKING SYSTEM</h5>
                  <div class="text-center">
                    <img src="../view/img/logo/attnlg.jpg" style="width:100px;height:100px">
                    <br><br>
